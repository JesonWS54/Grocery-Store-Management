...
namespace Grocery_Store_Management
{
    public partial class Customer : Form
    {
        ...
        private async void BtnInventory_Click(object sender, EventArgs e)
        {
            ...
            await CustomApplicationContext.SwitchForm(this, inventoryForm);
        }
        ...
        private async void BtnSales_Click(object sender, EventArgs e)
        {
            ...
            await CustomApplicationContext.SwitchForm(this, salesForm);
        }
        ...
        private async void BtnEmployee_Click(object sender, EventArgs e)
        {
            ...
            await CustomApplicationContext.SwitchForm(this, employeeForm);
        }
        ...
        private async void BtnFinance_Click(object sender, EventArgs e)
        {
            ...
            await CustomApplicationContext.SwitchForm(this, financeForm);
        }

        private async void BtnLogout_Click(object sender, EventArgs e)
        {
            await CustomApplicationContext.Logout(this);
        }
